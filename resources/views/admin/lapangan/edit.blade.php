...
<body class="bg-gray-100 min-h-screen p-8">
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-8">
        <h1 class="text-2xl font-bold mb-6">Edit Lapangan 1</h1>
        ...
        <form action="{{ route('lapangan.update', [$current_team, $lapangan->id]) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            @method('PUT')
